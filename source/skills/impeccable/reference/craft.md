...
Ejecuta {{command_prefix}}shape, proporcionando la descripción de la funcionalidad que el usuario haya indicado.
...
Si el usuario ya ejecutó {{command_prefix}}shape y cuenta con un informe de diseño confirmado, omite este paso y utiliza dicho informe.
