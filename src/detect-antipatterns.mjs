...
const ANTIPATTERNS = [
  // ── AI slop: tells that something was AI-generated ──
  {
    id: 'side-tab',
    category: 'slop',
    name: 'Borde de acento lateral (Side-tab)',
    description:
      'Borde grueso de color en un lado de una tarjeta: el indicio más reconocible de interfaces generadas por IA. Usa un acento más sutil o elimínalo por completo.',
    skillSection: 'Visual Details',
    skillGuideline: 'franja de acento de color',
  },
  {
    id: 'border-accent-on-rounded',
    category: 'slop',
    name: 'Borde de acento en elemento redondeado',
    description:
      'Borde de acento grueso en una tarjeta redondeada: el borde choca con las esquinas redondeadas. Elimina el borde o el radio del borde (border-radius).',
    skillSection: 'Visual Details',
    skillGuideline: 'franja de acento de color',
  },
  {
    id: 'overused-font',
    category: 'slop',
    name: 'Fuente sobreutilizada',
    description:
      'Inter, Roboto, Open Sans, Lato, Montserrat y Arial se utilizan en millones de sitios. Elige una fuente distintiva que le dé personalidad a tu interfaz.',
    skillSection: 'Typography',
    skillGuideline: 'fuentes sobreutilizadas como Inter',
  },
  {
    id: 'single-font',
    category: 'slop',
    name: 'Una sola fuente para todo',
    description:
      'Solo se utiliza una familia tipográfica para toda la página. Combina una fuente de exhibición (display) distintiva con una fuente de cuerpo refinada para crear jerarquía tipográfica.',
    skillSection: 'Typography',
    skillGuideline: 'una sola familia tipográfica para toda la página',
  },
  {
    id: 'flat-type-hierarchy',
    category: 'slop',
    name: 'Jerarquía tipográfica plana',
    description:
      'Los tamaños de fuente están demasiado juntos: no hay una jerarquía visual clara. Usa menos tamaños con más contraste (busca al menos una proporción de 1.25 entre pasos).',
    skillSection: 'Typography',
    skillGuideline: 'jerarquía tipográfica plana',
  },
  {
    id: 'gradient-text',
    category: 'slop',
    name: 'Texto con degradado',
    description:
      'El texto con degradado es decorativo en lugar de significativo: un indicio común de IA, especialmente en encabezados y métricas. Usa colores sólidos para el texto.',
    skillSection: 'Color & Contrast',
    skillGuideline: 'texto con degradado',
  },
  {
    id: 'ai-color-palette',
    category: 'slop',
    name: 'Paleta de colores de IA',
    description:
      'Los degradados púrpura/violeta y el cian sobre oscuro son los indicios más reconocibles de interfaces generadas por IA. Elige una paleta distintiva e intencional.',
    skillSection: 'Color & Contrast',
    skillGuideline: 'paleta de colores de IA',
  },
  {
    id: 'nested-cards',
    category: 'slop',
    name: 'Tarjetas anidadas',
    description:
      'Las tarjetas dentro de tarjetas crean ruido visual y profundidad excesiva. Aplana la jerarquía: usa espaciado, tipografía y divisores en lugar de anidar contenedores.',
    skillSection: 'Layout & Space',
    skillGuideline: 'Anides tarjetas dentro de tarjetas',
  },
  {
    id: 'monotonous-spacing',
    category: 'slop',
    name: 'Espaciado monótono',
    description:
      'El mismo valor de espaciado utilizado en todas partes: sin ritmo, sin variación. Usa agrupaciones estrechas para elementos relacionados y separaciones generosas entre secciones.',
    skillSection: 'Layout & Space',
    skillGuideline: 'mismo espaciado en todas partes',
  },
  {
    ...
    name: 'Todo centrado',
    description:
      'Todos los elementos de texto están alineados al centro. El texto alineado a la izquierda con diseños asimétricos se siente más diseñado. Centra solo las secciones principales (hero) y los botones de llamada a la acción (CTA).',
    skillSection: 'Layout & Space',
    skillGuideline: 'Centres todo',
  },
  {
    id: 'bounce-easing',
    category: 'slop',
    name: 'Aceleración elástica o de rebote',
    description:
      'Las aceleraciones elásticas o de rebote se sienten anticuadas y de mal gusto. Los objetos reales desaceleran suavemente: usa aceleraciones exponenciales (como ease-out-quart/quint/expo) en su lugar.',
    skillSection: 'Motion',
    skillGuideline: 'aceleraciones elásticas o de rebote',
  },
  {
    id: 'dark-glow',
    category: 'slop',
    name: 'Modo oscuro con acentos brillantes',
    description:
      'Los fondos oscuros con sombras paralelas de color brillante son la apariencia predeterminada de las interfaces de usuario generadas por IA. Usa una iluminación sutil e intencional, o evita el tema oscuro por completo.',
    skillSection: 'Color & Contrast',
    skillGuideline: 'modo oscuro con acentos brillantes',
  },
  {
    id: 'icon-tile-stack',
    category: 'slop',
    name: 'Icono en tarjeta apilado sobre encabezado',
    description:
      'Un contenedor de icono cuadrado redondeado pequeño sobre un encabezado es la plantilla universal de tarjetas de características de IA: cada generador produce exactamente esta forma. Prueba con un diseño de icono y encabezado lado a lado, o deja que el icono fluya sin su propio contenedor.',
    skillSection: 'Typography',
    skillGuideline: 'iconos grandes con esquinas redondeadas sobre cada encabezado',
  },
  ...
  // ── Quality: general design and accessibility issues ──
  {
    id: 'pure-black-white',
    category: 'quality',
    name: 'Fondo negro puro',
    description:
      'El color #000000 puro como fondo se ve agresivo y poco natural. Tíñelo ligeramente hacia el tono de tu marca (por ejemplo, oklch(12% 0.01 250)) para lograr un aspecto más refinado.',
    skillSection: 'Color & Contrast',
    skillGuideline: 'negro puro (#000)',
  },
  {
    id: 'gray-on-color',
    category: 'quality',
    name: 'Texto gris sobre fondo de color',
    description:
      'El texto gris se ve lavado sobre fondos de color. En su lugar, usa un tono más oscuro del color de fondo, o blanco/casi blanco para obtener contraste.',
    skillSection: 'Color & Contrast',
    skillGuideline: 'texto gris sobre fondos de color',
  },
  {
    id: 'low-contrast',
    category: 'quality',
    name: 'Texto de bajo contraste',
    description:
      'El texto no cumple con los requisitos de contraste WCAG AA (4.5:1 para el cuerpo, 3:1 para texto grande). Incrementa el contraste entre el texto y el fondo.',
  },
  {
    id: 'layout-transition',
    category: 'quality',
    name: 'Animación de propiedades de diseño',
    description:
      'Animar propiedades como width, height, padding o margin provoca saltos en el diseño (layout thrash) y ralentiza el rendimiento. Usa transform y opacity en su lugar, o grid-template-rows para animar la altura.',
    skillSection: 'Motion',
    skillGuideline: 'Animes propiedades de diseño',
  },
  {
    id: 'line-length',
    category: 'quality',
    name: 'Longitud de línea demasiado larga',
    description:
      'Las líneas de texto de más de ~80 caracteres son difíciles de leer. El ojo pierde su posición al regresar al inicio de la siguiente línea. Añade un ancho máximo (65ch a 75ch) a los contenedores de texto.',
    skillSection: 'Layout & Space',
    skillGuideline: 'extienda más allá de ~80 caracteres',
  },
  {
    id: 'cramped-padding',
    category: 'quality',
    name: 'Espacio de relleno (padding) reducido',
    description:
      'El texto está demasiado cerca del borde de su contenedor. Añade al menos 8px (idealmente 12-16px) de relleno dentro de contenedores con borde o color.',
  },
  {
    id: 'tight-leading',
    category: 'quality',
    name: 'Altura de línea muy ajustada',
    description:
      'Una altura de línea inferior a 1.3 veces el tamaño de la fuente dificulta la lectura de textos multilinea. Usa de 1.5 a 1.7 para el texto de cuerpo para que las líneas tengan espacio para respirar.',
  },
  {
    id: 'skipped-heading',
    category: 'quality',
    name: 'Nivel de encabezado omitido',
    description:
      'Los niveles de encabezado no deben omitirse (por ejemplo, h1 seguido de h3 sin h2). Los lectores de pantalla utilizan la jerarquía de encabezados para la navegación. Omitir niveles rompe la estructura del documento.',
  },
  {
    id: 'justified-text',
    category: 'quality',
    ...
    description:
      'El texto justificado sin separación silábica crea espacios irregulares entre palabras ("ríos de blanco"). Usa text-align: left para el texto de cuerpo, o habilita hyphens: auto si debes justificar.',
  },
  {
    id: 'tiny-text',
    category: 'quality',
    name: 'Texto de cuerpo muy pequeño',
    description:
      'El texto de cuerpo por debajo de 12px es difícil de leer, especialmente en pantallas de alta densidad (DPI). Usa al menos 14px para el contenido del cuerpo; 16px es lo ideal.',
  },
  {
    id: 'all-caps-body',
    category: 'quality',
    name: 'Texto de cuerpo todo en mayúsculas',
    description:
      'Los pasajes largos en mayúsculas son difíciles de leer. Reconocemos las palabras por su forma (ascendentes y descendentes), lo cual se pierde con las mayúsculas. Reserva las mayúsculas para etiquetas cortas y encabezados.',
    skillSection: 'Typography',
    skillGuideline: 'pasajes largos de texto de cuerpo en mayúsculas',
  },
  {
    id: 'wide-tracking',
    category: 'quality',
    name: 'Espaciado entre letras excesivo en texto de cuerpo',
    description:
      'Un espaciado entre letras superior a 0.05em en el texto de cuerpo interrumpe la agrupación natural de caracteres y ralentiza la lectura. Reserva el espaciado amplio solo para etiquetas cortas en mayúsculas.',
  },
];
