...
Selecciona automáticamente las 2-3 personas más relevantes para este tipo de interfaz (usa la tabla de selección en la referencia). Si el archivo `.github/copilot-instructions.md` contiene una sección `## Contexto de diseño` proveniente de `impeccable teach`, genera también 1-2 personas específicas del proyecto basándote en la información de la audiencia y de la marca.
