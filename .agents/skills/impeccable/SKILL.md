...
Luego ask the user directly to clarify what you cannot infer. si también desean que el Contexto de diseño se agregue a .github/copilot-instructions.md. Si es así, agrégalo o actualiza la sección allí también.
