...
**CRÍTICO**: Si no existe un sistema de diseño, ask the user directly to clarify what you cannot infer. antes de crear uno. Comprende primero la ubicación y estructura de preferencia.
