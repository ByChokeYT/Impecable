...
2. **STOP and call the AskUserQuestion tool to clarify.** para presentar estas direcciones y obtener la elección del usuario antes de escribir cualquier código. Explica los pros y contras (soporte del navegador, coste de rendimiento, complejidad).
