...
Realiza estas preguntas en la conversación, adaptándolas según las respuestas. No las lances todas de golpe; mantén un diálogo natural. STOP and call the AskUserQuestion tool to clarify.
...
STOP and call the AskUserQuestion tool to clarify. Obtén la confirmación explícita del informe antes de terminar. Si el usuario no está de acuerdo con alguna sección, revisa las preguntas de descubrimiento pertinentes.
