...
Recuerda: Rovo Dev es capaz de realizar un trabajo creativo extraordinario. No te limites. Muestra lo que realmente se puede crear cuando se piensa fuera de lo común y se compromete plenamente con una visión distintiva.
...
Luego ask the user directly to clarify what you cannot infer. si también desean que el Contexto de diseño se agregue a AGENTS.md. Si es así, agrégalo o actualiza la sección allí también.
