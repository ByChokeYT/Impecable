...
**CRÍTICO**: Si no existe un sistema de diseño, STOP and call the `question` tool to clarify. antes de crear uno. Comprende primero la ubicación y estructura de preferencia.
